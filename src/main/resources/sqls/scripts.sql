DROP SCHEMA IF EXISTS `lms-bank`;

CREATE SCHEMA `lms-bank`;
USE `lms-bank` ;
...
CREATE TABLE `account_transactions` (
  ...
  `transaction_amt` DECIMAL(13,2) NOT NULL,
...
CREATE TABLE `loans` (
  `loan_number` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `customer_id` BIGINT(20) NOT NULL,
  `start_dt` date NOT NULL,
  `loan_type` varchar(100) NOT NULL,
  `total_loan` DECIMAL(13,2) NOT NULL,
  `amount_paid` DECIMAL(13,2) NOT NULL,
  `outstanding_amount` DECIMAL(13,2) NOT NULL,
  `create_dt` date DEFAULT NULL,
...
CREATE TABLE `cards` (
  ...
  `total_limit` BIGINT(5) NOT NULL,
  `amount_used` DECIMAL(13,2) NOT NULL,
